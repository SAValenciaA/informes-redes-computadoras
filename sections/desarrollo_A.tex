...
estando caido:
\begin{center}
  \texttt{*Mar  1 01:53:44.870: *** vp\_linkchange: single: \textcolor{red}{down}: 1/3(1) }
\end{center}
...
\begin{center}
  \texttt{*mar  1 01:53:42.999:     cfg p:0000 v:00 t:00 f:00 r:8001 \textcolor{red}{001c.f6b4.2480} ...}
\end{center}
...
\begin{center}
  \texttt{*Mar  1 01:53:44.870: STP: VLAN0001 new root port Fa0/2, cost 23}
\end{center}
...
\noindent\texttt{*Mar  1 01:54:02.998: STP SW: Gi0/1 new blocking req for 1 vlans}

\noindent\texttt{*Mar  1 01:54:02.998: STP[1]: Generating TC trap for port GigabitEt...}

\noindent\texttt{*Mar  1 01:54:02.998: STP: VLAN0001 Gi0/1 -> blocking}
